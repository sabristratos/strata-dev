...
<div class="flex flex-col gap-1">
    <div 
        x-data="{
            value: <?php if($attributes->has('wire:model')): ?> <?php if ((object) ($attributes->get('wire:model')) instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e($attributes->get('wire:model')->value()); ?>')<?php echo e($attributes->get('wire:model')->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e($attributes->get('wire:model')); ?>')<?php endif; ?> <?php else: ?> <?php echo e($checked ? 'true' : 'false'); ?> <?php endif; ?>,
    ...
    >
    <!--[if BLOCK]><![endif]--><?php if($name && !$attributes->has('wire:model')): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($position === 'after' && ($label || $description)): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'cursor-pointer select-none !mb-0','@click' => '$refs.switchButton.click(); $refs.switchButton.focus()']); ?>
                    <?php echo e($label); ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($position === 'before' && ($label || $description)): ?>
        <div class="flex flex-col items-start gap-1">
            <!--[if BLOCK]><![endif]--><?php if($label): ?>
                <?php if (isset($component)) { $__componentOriginal3ea2f8edb912a0e37cb1305e82ccd412 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3ea2f8edb912a0e37cb1305e82ccd412 = $attributes; } ?>
...
<?php endif; ?>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH C:\Users\chaab\Herd\strata\packages\strata-ui\src/../resources/views/components/form/toggle.blade.php ENDPATH**/ ?>