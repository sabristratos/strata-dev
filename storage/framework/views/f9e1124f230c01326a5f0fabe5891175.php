...
<div
    ...
    <?php echo e($attributes->except(['variant', 'size', 'autoplay', 'interval', 'loop', 'showArrows', 'showDots', 'itemsPerView', 'gap', 'snapAlign', 'hideScrollbar', 'wire:model', 'wire:model.self'])->merge([
...
<?php if (! $__env->hasRenderedOnce('f7fa404f-c0a4-4260-a198-64250832758a')): $__env->markAsRenderedOnce('f7fa404f-c0a4-4260-a198-64250832758a'); ?>
<style>
...
<?php endif; ?><?php /**PATH C:\Users\chaab\Herd\strata-dev\packages\strata-ui\src/../resources/views/components/carousel.blade.php ENDPATH**/ ?>