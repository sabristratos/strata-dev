...
<div 
    ...
    x-modelable="value"
    <?php if($hasWireModel): ?> <?php echo e($attributes->get('wire:model')); ?> <?php endif; ?>
...
>
    ...
    <div class="flex items-center <?php echo e($getGapClasses()); ?>" <?php if(!$readonly): ?> @mouseleave="onMouseLeave()" <?php endif; ?>>
        <!--[if BLOCK]><![endif]--><?php for($i = 1; $i <= $max; $i++): ?>
            <button
                ...
                :class="{
                    '<?php echo e($getActiveColorClass()); ?>': (stars || 0) >= <?php echo e($i); ?>,
                    'text-muted-foreground/40': (stars || 0) < <?php echo e($i); ?>,
...
<?php endif; ?>
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($getSizeClasses()),'x-show' => '(stars || 0) >= '.e($i).'']); ?>
...
<?php /**PATH C:\Users\chaab\Herd\strata\packages\strata-ui\src/../resources/views/components/form/rating.blade.php ENDPATH**/ ?>