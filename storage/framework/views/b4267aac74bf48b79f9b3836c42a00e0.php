...
>
    ...
    <summary
        <?php if($disabled): ?>
            disabled
        <?php endif; ?>
        class="flex items-center justify-between w-full text-left group <?php echo e($disabled ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'); ?> p-4 text-foreground hover:bg-muted/50 transition-colors"
...
<?php /**PATH C:\Users\chaab\Herd\strata\packages\strata-ui\src/../resources/views/components/accordion/item.blade.php ENDPATH**/ ?>