...
<?php endif; ?>
    ...
    <textarea
        <?php if($autoResize): ?>
            ...
            x-init="resize()"
        <?php else: ?>
            <?php if($attributes->wire('model')): ?>
                x-data="{ value: <?php if ((object) ($attributes->wire('model')) instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e($attributes->wire('model')->value()); ?>')<?php echo e($attributes->wire('model')->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e($attributes->wire('model')); ?>')<?php endif; ?> }"
                x-model="value"
            <?php else: ?>
    ...
    ><!--[if BLOCK]><![endif]--><?php if(!$attributes->wire('model') && $value): ?><?php echo e($value); ?><?php endif; ?><!--[if ENDBLOCK]><![endif]--></textarea>
...
<?php endif; ?>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH C:\Users\chaab\Herd\strata-dev\packages\strata-ui\src/../resources/views/components/form/textarea.blade.php ENDPATH**/ ?>