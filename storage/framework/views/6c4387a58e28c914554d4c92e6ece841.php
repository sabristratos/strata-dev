...
>
    <!--[if BLOCK]><![endif]--><?php if($isHamburger()): ?>
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($variant === 'button' && $slot->isNotEmpty()): ?>
            <span class="ml-2">
                <?php echo e($slot); ?>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]--><?php /**PATH C:\Users\chaab\Herd\strata-dev\packages\strata-ui\src/../resources/views/components/sidebar-toggle.blade.php ENDPATH**/ ?>