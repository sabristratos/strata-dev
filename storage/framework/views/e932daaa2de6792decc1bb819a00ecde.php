...
<div <?php echo e($attributes->merge(['class' => $baseClasses . ' ' . $sizeClasses])); ?> style="<?php echo e($paddingVariables); ?>">
    <table class="<?php echo e($tableClasses); ?>">
        <?php echo e($slot); ?>

    </table>

    <!--[if BLOCK]><![endif]--><?php if($loading): ?>
        <div class="absolute inset-0 bg-background/80 flex items-center justify-center backdrop-blur-xs">
...
</div><?php /**PATH C:\Users\chaab\Herd\strata\packages\strata-ui\src/../resources/views/components/table.blade.php ENDPATH**/ ?>