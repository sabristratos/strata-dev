...
class Modal extends Component
{
    ...
    public function getVariantClasses(): string
    {
        return match ($this->variant) {
            ...
            default => 'bg-card text-card-foreground modal-radius shadow-xl border border-border',
        };
    }
    ...
    {
        $baseClasses = 'h-full max-h-none bg-card text-card-foreground shadow-2xl border-border';
    ...
    public function getFlyoutPositionClasses(): string
    {
        ...
        return match ($this->position) {
            'left' => 'left-0 top-0',
            'bottom' => 'bottom-0 left-0 w-full max-w-none modal-radius rounded-b-none',
